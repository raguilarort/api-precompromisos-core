...
@Tag(name = "Claves Presupuestarias", description = "Gestión de la estructura programática-presupuestal y sus saldos")
public class ClavesPresupuestariasController {
    ...
    public ResponseEntity<DisponibilidadClavePresupuestariaDTO> consultarDisponibilidad(
        ...
        return ResponseEntity.ok(service.consultarDisponibilidad(idClavePresupuestaria));
    }
    ...
    public ResponseEntity<DisponibilidadClavePresupuestariaDTO> consultarDisponibilidad(
        ...
        // Nota: Si la combinación no existe en BD, el service debería lanzar una excepción
        // (ej. CombinacionNoEncontradaException) que tu ControllerAdvice convierta en un 404 Not Found.
