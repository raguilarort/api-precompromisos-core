...
public record FiltroClavePresupuestariaDTO(
        ...
        @Parameter(description = "Identificador de la fuente de financiamiento")
        @NotNull(message = "El identificador de la fuente de financiamiento es obligatorio")
        Integer idFuenteFin
) {}